...
---
if(vars.queryParams.parentId != null) mergedPayments filter ($.parentId == vars.queryParams.parentId and !isBlank($.amount)) else mergedPayments filter !isBlank($.amount)
